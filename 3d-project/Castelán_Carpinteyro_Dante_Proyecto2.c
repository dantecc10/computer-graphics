...
// Actualización del estado de animación (ahora integrada en conejo())
// Modificar la función actualizarAnimacion() para incluir el salto
...
// Función para manejar teclas normales
void teclado(unsigned char tecla, int x, int y)
{
    if (tecla == 27) // ESC
    {
        animacionActiva = 0; // Detener animación
...
int main(int argc, char **argv)
{
    ...
    // Registrar función de teclado para salir
